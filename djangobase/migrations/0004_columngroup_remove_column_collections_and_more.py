...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('djangobase', '0003_relation_column'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='djangobase.collection')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='column',
            name='column_group',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='columns', to='djangobase.columngroup'),
        ),
    ]
